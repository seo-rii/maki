...
logical zero remains durable but the old physical allocation can remain. There
is currently no background scan that retries such missed physical reclamation.
